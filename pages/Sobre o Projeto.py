...
st.markdown('[Fonte de dados do Preço do Petróleo](http://www.ipeadata.gov.br/ExibeSerie.aspx?module=m&serid=1650971490&oper=view)')
st.markdown('[Fonte de dados da taxa de Câmbio Dólar (US$) - Real (R$) ](http://www.ipeadata.gov.br/ExibeSerie.aspx?serid=38590&module=M)')
st.markdown('[Repositório do projeto no Github](https://github.com/kfpetruz/Dash-e-Modelo-Preditivo-Combustiveis)') # Lembrar de tornar público para entregar
