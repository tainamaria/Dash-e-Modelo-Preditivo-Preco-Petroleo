...
st.markdown('<p style="text-align: justify;"> <span style="color:#ED7D31; font-weight: bold">Maio/2011:</span>  xpto xptoxpto xptoxpto xptoxpto xptoxpto xptoxpto xpto </p>', unsafe_allow_html = True) 
st.markdown('<p style="text-align: justify;"> <span style="color:#ED7D31; font-weight: bold">Março/2012:</span>  xpto xptoxpto xptoxpto xptoxpto xptoxpto xptoxpto xpto </p>', unsafe_allow_html = True) 
